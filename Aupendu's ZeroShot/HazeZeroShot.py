...
parser.add_argument('--TestFolderPath', type=str, default='data/I-HazeFullx', help='Hazy Image folder name') 
parser.add_argument('--SavePath', type=str, default='hazeresults/14_feb_2/', help='SavePath Name')
...
def test(args):
    ...
    for i in range(len(InputImages)):
        image_name = InputImages[i]
        save_path = os.path.join(args.SavePath, image_name[:-4] + '.png')
        ...
        Input = imageio.imread(args.TestFolderPath+'/Input/'+image_name)
        ...
        torchvision.utils.save_image(_GT, save_path)
